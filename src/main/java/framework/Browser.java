	...
	public static WebDriver startBrowser() {
		...
		case "chrome":
			//WebDriverManager.chromedriver().setup();
			  ...
			  equalsIgnoreCase("windows")) { System.setProperty("webdriver.chrome.driver",
			  ...
			  equalsIgnoreCase("linux")) { System.setProperty("webdriver.chrome.driver",
			  System.getProperty("user.dir")+"/drivers/Linux/Chrome/chromedriver"); }
