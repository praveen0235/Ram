...
Background: User is Logged In
 	Given navigate to given URL "https://dmr-uat.exela.global/#/login" 
...
Scenario: Verify functionality of Delegate Inbox for client admin
	...
	When   enter email id as "Chitra.test@yopmail.com" to whom you want to delegate the inbox 
	...
	Then enter yopmail id as "Chitra.test@yopmail.com"
...
Scenario: Verify User is able to create routing rule on move to folder action
	...
	When   select drop down option as "Regression Suite_project"
...
Scenario: Verify User is able to create routing rule on Send To action
	...
	When   click on lookup
	Then enter recepient as "dmruattesting@yopmail.com" and select it
	When   click on Send
	When   click on save button
	Then User should get success msg as "Auto routing details added successfully"
...
Scenario: Verify User is able to create routing rule on Re-route action
    ...
    When   click on lookup
	Then enter re-route recepient as "chitra.test@yopmail.com" and select it
	When   click on Send
	When   click on save button
	Then User should get success msg as "Auto routing details added successfully"
...
Scenario: Verify client admin is able to Delegate Other User's Inbox 
	...
	When   Enter the User one's mail id as "chitramailuser@yopmail.com" whose inbox you want to delegate 
	When   select from date as today and to date is additional of two days of today
	When   enter email id as "Chitra.test@yopmail.com" of User two you want to delegate the inbox 
	When   click on save button
	Then navigate to given URL "http://www.yopmail.com/en/"
	Then enter yopmail id as "Chitra.test@yopmail.com"
	When click on check inbox
