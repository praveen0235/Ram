...
Given navigate to given URL "https://exela-app-qa.exela.global/#/login" 
   ...
   When click on drop down Arrow "Select Service Line*" 
    ...
    And logout
    @Yes
    Scenario: To check whether user should be able to check on any and all of these reports to select for this client
Given navigate to given URL "https://exela-app-qa.exela.global/#/login" 
	Then enter username as "admin"
	Then click on next button
	Then enter Password as "Pa$$w0rd1"
   ...
   Then filter the role name "testing123"
   When   click on edit.
...
Given navigate to given URL "https://exela-app-qa.exela.global/#/login" 
 ...
 Then update the "Base.xml" with below values and zip it with "document_2_envelope_page_1.pdf" and "merged.pdf"
|FieldName|CapturedValue|Value|
|Recipient Email|varshadighe3108@yopmail.com|varshadighe3108@yopmail.com|
Then ingest the above zipped file to Azure Blob Storage
Then navigate to given URL "https://dmr-qa.exela.global/#/login" 
Then enter username as "septclient"
Then click on next button
...
Then filter autogenerated DCN and verify it is available
Then system should display the user name as "SMB1"
Then system should display the event as "Created"
Then Click on profile picture
And logout
@Yespraveen
...
Then first record in excel against user column should be "septClient sept2020" and event column should be "Mail Status Change"
Then Click on profile picture
And logout
@Yes
...
Then click on the report "Chain of Custody Report"
Then click on download icon
Then record in excel against From column should be "septclient" and TO column should be "varsha001"
Then Click on profile picture
And logout
@Yes
...
Then open new tab and navigate to "http://www.yopmail.com/en/"
Then enter yopmail id as "varshadighe310891@yopmail.com"
When click on check inbox
...
Then enter the OTP
And submit the OTP
Then enter the new password as "Pa$$w0rd"
Then confirm the new password as "Pa$$w0rd"
Then click on change password button
Then System should throw a toggle message as "Your password has been successfully changed. Please relogin."

@Yes
Scenario: Reset Password
Then navigate to given URL "http://www.yopmail.com/en/"
Then enter yopmail id as "varshaghag@yopmail.com"
When click on check inbox
Then click on delete dropdown
Then click on empty inbox
Then navigate to given URL "https://dmr-qa.exela.global/#/login"
...
And click on signin button
Then click on left pane menu "User Setup"
Then filter login name "v31"
When click on edit.
Then click on reset password option
Then set password as "Welcome@123"
When click on SAVE button
Then System should throw a toggle message as "Password has been reset successfully"
Then Click on profile picture
And logout
Then navigate to given URL "http://www.yopmail.com/en/"
Then enter yopmail id as "varshaghag@yopmail.com"
When click on check inbox
Then system should display "User Password Reset" email
Then body of the mail should contain the password "Welcome@123"
 
@Yes
Scenario: To check the contents of mail received as new notification mail when users shared mailbox when new file is ingested for user  having access of shared mailbox folder
Then update the "small.xml" with below values and zip it with "document_8_envelope_page_1.pdf" and "small.pdf"
|FieldName|CapturedValue|Value|
|Document_Type|Human Resource|Human Resource|
Then ingest the above zipped file to Azure Blob Storage
Then navigate to given URL "https://dmr-qa.exela.global/#/login" 
...
Then select an email
Then select action as "Send For DrySign"
Then enter receipient as "mailadminauto@yopmail.com" and select it
When click on send butn
Then click on add fields option
Then drag and drop the name
And select the name
Then drag and drop the signature
And select the signature
Then click on submit button
Then filter autogenerated DCN and verify it is available
Then status of the mail should be "Send For Drysign"
Then Click on profile picture
And logout
...
Then select an email
Then select action as "Send To"
Then enter recepient as "mailadminauto@yopmail.com" and select it
When click on send butn
...
Then redact the PDF at X-axis "273" and at Y-axis "62"
...
Then select an email
Then select action as "Send To"
Then enter recepient as "Varshadighe31@yopmail.com" and select it
When click on send butn
Then click on send mail button
Then System should throw a toggle message as "Digital Mail Sent successfully"
Then Click on profile picture
